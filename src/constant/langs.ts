...
export const LangsMap: Record<LangEnum, { name: string; icon: DefineComponent; code: string }> = {
  ...
  [LangEnum.SPANISH]: { name: 'Spanish', icon: '', code: LangEnum.SPANISH },
  ...
  [LangEnum.PORTUGUESE]: { name: 'Portuguese', icon: '', code: LangEnum.PORTUGUESE },

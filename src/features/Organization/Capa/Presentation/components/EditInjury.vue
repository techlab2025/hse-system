...
import ShowInjurytController from '../controllers/showInjuryController'
import ShowInjuryParams from '../../Core/params/showInjuryParams'
import EditInjuryController from '../controllers/editInjuryController'

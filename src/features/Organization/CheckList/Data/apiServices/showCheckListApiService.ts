...
class ShowCheckListApiService extends ServicesInterface {
  private static instance: ShowCheckListApiService
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new ShowCheckListApiService()
    }
...
export { ShowCheckListApiService }

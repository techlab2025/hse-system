  ...
  import IndexWhereHouseTypeController from '../controllers/indexCheckListController';
  ...
  import AddWhereHouseTypeCloneController from '../controllers/addCheckListController';

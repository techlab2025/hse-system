...
class ShowWhereHouseTypeApiService extends ServicesInterface {
  private static instance: ShowWhereHouseTypeApiService
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new ShowWhereHouseTypeApiService()
    }
...
export { ShowWhereHouseTypeApiService }

...
export default class IndexDrillTypeController extends SelectControllerInterface<
  DrillTypeModel[]
> {
  private static instance: IndexDrillTypeController
  private constructor() {
    super()
  }
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new IndexDrillTypeController()
    }

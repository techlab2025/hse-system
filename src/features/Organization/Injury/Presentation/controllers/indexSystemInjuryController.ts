...
export default class IndexSystemInjuryController extends SelectControllerInterface<
  InjuryModel[]
> {
  private static instance: IndexSystemInjuryController
  private constructor() {
    super()
  }
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new IndexSystemInjuryController()
    }

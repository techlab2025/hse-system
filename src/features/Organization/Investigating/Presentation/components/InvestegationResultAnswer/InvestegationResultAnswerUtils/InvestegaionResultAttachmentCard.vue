...
<template>
  <div class="investegaion-attachment-card">
    <p class="title">{{ attachment?.title }}</p>
    <div class="investegaion-attachment-card-media">
      <img v-for="(img, index) in attachment?.media" :key="index" :src="img?.url" alt="img" />
    </div>
  </div>
</template>

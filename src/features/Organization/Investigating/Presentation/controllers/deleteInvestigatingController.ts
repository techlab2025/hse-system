...
import DeleteHazardUseCase from '../../Domain/useCase/deleteInvestigatingUseCase'
...
export default class DeleteHazardController extends ControllerInterface<HazardModel> {
  ...
  async deleteHazard(params: Params) {
    ...
    // console.log(params)
    try {
      const dataState: DataState<HazardModel> = await this.DeleteHazardUseCase.call(params)

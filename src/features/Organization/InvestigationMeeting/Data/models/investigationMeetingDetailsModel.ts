...
export default class InvestigationMeetingDetailsModel {
  public id: number
  public title: string
  ...
  static fromMap(data: any): InvestigationMeetingDetailsModel {
    return new InvestigationMeetingDetailsModel(
      data.id,
      data.title,
      data.description,
      data.image,

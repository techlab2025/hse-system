...
export default class AddMangementChangeParams implements Params {
  ...
  toMap(): Record<string, unknown> {
    return {
      ...
      date: this.date
        ? formatJoinDate(this.date)
        : undefined,

      change_type: this.change_type,

      management_change_topic_type_id:
        this.management_change_topic_type_id,
      ...
      management_change_topic_employee_id:
        this.management_change_topic_employee_id,

      management_change_topic_equipment_id:
        this.management_change_topic_equipment_id,

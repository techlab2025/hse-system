...
export default class IndexMangementChangeTopicTypeController extends SelectControllerInterface<
  MangementChangeTopicTypeModel[]
> {
  private static instance: IndexMangementChangeTopicTypeController
  private constructor() {
    super()
  }
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new IndexMangementChangeTopicTypeController()
    }

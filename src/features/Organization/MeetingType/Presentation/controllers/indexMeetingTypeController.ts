...
export default class IndexMeetingTypeController extends SelectControllerInterface<
  MeetingTypeModel[]
> {
  private static instance: IndexMeetingTypeController
  private constructor() {
    super()
  }
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new IndexMeetingTypeController()
    }

...
@media (max-width: 480px) {
  ...
  .timeline-content :deep(.flex.items-center) {
    min-width: 0;
    flex-wrap: wrap;
  }

  .timeline-content :deep(.emp-name),
  .timeline-content :deep(.emp-select) {
    max-width: 100%;
    white-space: normal;
  ...
  .timeline-content :deep(.input),
  .timeline-content :deep(.p-select) {
    width: 100% !important;

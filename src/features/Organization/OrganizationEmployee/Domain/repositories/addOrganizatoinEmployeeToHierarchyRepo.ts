...
import { AddOrganizatoinEmployeeToHierarchyApiService } from '../../Data/apiServices/addOrganizatoinEmployeeToHierarchyApiService'
...
class AddOrganizationEmployeeToHierarchyRepo extends RepoInterface<OrganizatoinEmployeeModel> {
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new AddOrganizationEmployeeToHierarchyRepo()
    }
  ...
  get serviceInstance(): ServicesInterface {
    return AddOrganizatoinEmployeeToHierarchyApiService.getInstance()
  }
}

export { AddOrganizationEmployeeToHierarchyRepo }

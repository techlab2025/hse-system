...
export default class IndexOrganizatoinEmployeeToAddToHierarchyController extends SelectControllerInterface<
  OrganizatoinEmployeeModel[]
> {
  private static instance: IndexOrganizatoinEmployeeToAddToHierarchyController
  private constructor() {
    super()
  }
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new IndexOrganizatoinEmployeeToAddToHierarchyController()
    }

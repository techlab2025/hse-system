...
export default class IndexPPEActivityController extends SelectControllerInterface<
  PPEActivityModel[]
> {
  private static instance: IndexPPEActivityController
  private constructor() {
    super()
  }
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new IndexPPEActivityController()
    }

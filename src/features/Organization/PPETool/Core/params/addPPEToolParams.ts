...
export default class AddPPEToolParams implements Params {
  constructor(
  ...
  toMap(): Record<string, unknown> {
    ...
    const data: Record<string, unknown> = { translations }
  ...
  validate() {
    return AddPPEToolParams.validation.validate(this)
  }

  validateOrThrow() {
    return AddPPEToolParams.validation.validateOrThrow(this)
  }
}

...
class ShowPPEToolApiService extends ServicesInterface {
  private static instance: ShowPPEToolApiService
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new ShowPPEToolApiService()
    }

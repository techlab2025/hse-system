...
export default class IndexSystemPPEToolController extends SelectControllerInterface<
  PPEToolModel[]
> {
  private static instance: IndexSystemPPEToolController
  private constructor() {
    super()
  }
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new IndexSystemPPEToolController()
    }

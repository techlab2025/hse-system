...
export default class IndexPTWTypeController extends SelectControllerInterface<
  PTWTypeModel[]
> {
  private static instance: IndexPTWTypeController
  private constructor() {
    super()
  }
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new IndexPTWTypeController()
    }

...
class EditInductionApiService extends ServicesInterface {
  private static instance: EditInductionApiService
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new EditInductionApiService()
    }
...
export { EditInductionApiService }

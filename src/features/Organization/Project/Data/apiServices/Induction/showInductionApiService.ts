...
class ShowInductionApiService extends ServicesInterface {
  private static instance: ShowInductionApiService
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new ShowInductionApiService()
    }
...
export { ShowInductionApiService }

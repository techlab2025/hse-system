...
class ShowProjectDetailsApiService extends ServicesInterface {
  private static instance: ShowProjectDetailsApiService
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new ShowProjectDetailsApiService()
    }
...
export { ShowProjectDetailsApiService }

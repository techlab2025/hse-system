...
class ShowProjectApiService extends ServicesInterface {
  private static instance: ShowProjectApiService
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new ShowProjectApiService()
    }

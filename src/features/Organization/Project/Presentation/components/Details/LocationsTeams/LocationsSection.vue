          ...
          <div class="location flex items-start">
            ...
            <div class="flex flex-col items-start gap-0">
              ...
              <div class="location-info-statics flex items-center gap-2">
                ...
                <p>
                  {{
                    CheckThatAtLeastOneEmployeeInTeams()
                      ? location?.projectLocationTeams?.length || 0
                      : 0
                  }}
                  <span>{{ $t('Teams') }}</span>
                </p>
          ...
          <div class="all-employees-header-container">
            <div class="flex items-center gap-2">
              ...
              <div class="all-employees-header flex flex-col">
                ...
                <p class="employee-count">
                  {{ location?.projectLocationTeams?.length }} {{ $t('Teams') }}
                </p>
              </div>
            </div>
            <router-link :to="`/organization/employee-details/${id}`" class="all-employees-view"
              >{{ $t('View all teams') }} ({{
                location?.projectLocationTeams?.length
              }})</router-link
            >
          </div>
          <div class="teams">

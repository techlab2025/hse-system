...
const UpdateData = () => {
  emit('update:value', {
    ...
    MapSelection: MapSelection.value || null,
...
const updateField = (field: string, value: any) => {
  switch (field) {
    ...
    case 'TotalCount': TotalCount.value = value; break
    case 'MapSelection': MapSelection.value = value; break
...
<template>
  ...
  <RadioSection title="Choose what you want to appear on the map." :selections="['locations', 'zones']"
    @update:value="v => updateField('MapSelection', v)" />
  <RadioSection title="who total count" :selections="['yes', 'No']" @update:value="v => updateField('TotalCount', v)" />

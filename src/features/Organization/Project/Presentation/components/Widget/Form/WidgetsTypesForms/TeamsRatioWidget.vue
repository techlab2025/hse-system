...
const UpdateData = () => {
  emit('update:value', {
    ...
    NumberOfTeams: NumberOfTeams.value || null
  })
}
...
const updateField = (field: string, value: any) => {
  switch (field) {
    ...
    case 'NumberOfTeams': NumberOfTeams.value = value; break
  }
  UpdateData()
}
...
<template>
  ...
  <RadioSection title="Choose the number of teams you want" :selections="['The two biggest teams', 'The 3 biggest teams'
    , 'The 4 biggest teams', 'The 5 biggest teams', 'The 6 biggest teams'
  ]" @update:value="v => updateField('NumberOfTeams', v)" />

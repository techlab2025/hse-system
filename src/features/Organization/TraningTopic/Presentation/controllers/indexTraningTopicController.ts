...
export default class IndexTraningTopicController extends SelectControllerInterface<
  TraningTopicModel[]
> {
  private static instance: IndexTraningTopicController
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new IndexTraningTopicController()
    }

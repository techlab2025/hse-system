...
export default class AddVisitActivityParams implements Params {
  ...
  validate() {
    return AddVisitActivityParams.validation.validate(this)
  }

  validateOrThrow() {
    return AddVisitActivityParams.validation.validateOrThrow(this)
  }
}

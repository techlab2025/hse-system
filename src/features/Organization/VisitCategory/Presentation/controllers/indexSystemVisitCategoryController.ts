...
export default class IndexSystemVisitCategoryController extends SelectControllerInterface<VisitCategoryModel[]> {
  private static instance: IndexSystemVisitCategoryController
  ...
  static getInstance() {
    if (!this.instance) this.instance = new IndexSystemVisitCategoryController()

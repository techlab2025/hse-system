...
import AddPpeItemParams from '../../Core/params/addVisitThemeParams'
import EditPpeItemParams from '../../Core/params/editPpParams'
...
<template>
  <div class="col-span-4 md:col-span-2" data-required-field="title">
    <LangTitleInput :langs="languages" :model-value="titles" :label="$t('ppe_item_title')"
      :placeholder="$t('enter_ppe_item_title')" @update:model-value="setTitles" />

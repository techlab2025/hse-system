...
const props = defineProps<{ data?: VisitThemeDetailsModel }>()
...
const requiredFields = computed(() => [
  {
    key: 'title',
    message: 'Visit Theme Title Is Required',
    isMissing: () =>
...
<template>
  <div class="col-span-4 md:col-span-2" data-required-field="title">
    <LangTitleInput
      :langs="languages"
      :model-value="titles"
      :label="$t('visit_theme_title')"
      :placeholder="$t('enter_visit_theme_title')"

...
export default class EditObjectivesParams implements Params {
  constructor(
    public id: number,
  ...
  validate() {
    return EditObjectivesParams.validation.validate(this)
  }

  validateOrThrow() {
    return EditObjectivesParams.validation.validateOrThrow(this)
  }
}

...
export default class IndexSystemPpeItemController extends SelectControllerInterface<
  PpeItemModel[]
> {
  private static instance: IndexSystemPpeItemController
  private constructor() {
    super()
  }
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new IndexSystemPpeItemController()
    }

...
import type EmployeeModel from '@/features/setting/Employee/Data/models/equipmentModel'
import AddEmployeeUseCase from '../../Domain/useCase/addEmployeeUseCase'
...
export default class AddEmployeeController extends ControllerInterface<EmployeeModel> {
  ...
  async addEmployee(params: Params, router: Router, draft: boolean = false) {
    // useLoaderStore().setLoadingWithDialog();
    try {
      const dataState: DataState<EmployeeModel> =
        await this.addEmployeeUseCase.call(params)

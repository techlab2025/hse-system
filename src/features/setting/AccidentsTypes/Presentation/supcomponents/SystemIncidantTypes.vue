...
const SubmitData = async () => {
  const addSystemAccidentsTypeController = AddSystemAccidentsTypeController.getInstance()
  const addSystemAccidentsTypeParams = new AddSystemAccidentsTypeParams({ cloneIds: selectedIds.value })

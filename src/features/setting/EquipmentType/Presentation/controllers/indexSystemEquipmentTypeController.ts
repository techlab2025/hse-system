...
export default class IndexSystemEquipmentTypeController extends SelectControllerInterface<
  EquipmentTypeModel[]
> {
  private static instance: IndexSystemEquipmentTypeController
  private constructor() {
    super()
  }
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new IndexSystemEquipmentTypeController()
    }

...
import { AddSystemIncidentCategoryApiService } from '../../Data/apiServices/addSystemIncidentCategoryApiService'
...
class AddSystemIncidentCategoryRepo extends RepoInterface<IncidentCategoryModel> {
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new AddSystemIncidentCategoryRepo()
    }
  ...
  get serviceInstance(): ServicesInterface {
    return AddSystemIncidentCategoryApiService.getInstance()
  }
}

export { AddSystemIncidentCategoryRepo }

...
import { DisIncidentCategoryApiService } from '../../Data/apiServices/disIncidentCategoryApiService'
...
class DisActiveIncidentCategoryRepo extends RepoInterface<IncidentCategoryModel> {
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new DisActiveIncidentCategoryRepo()
    }
  ...
  get serviceInstance(): ServicesInterface {
    return DisIncidentCategoryApiService.getInstance()
  }
}

export { DisActiveIncidentCategoryRepo }

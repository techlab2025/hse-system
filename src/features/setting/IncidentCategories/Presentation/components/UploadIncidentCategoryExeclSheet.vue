...
import AddIncidentCategoryExcelParams from '../../Core/params/AddIncidentCategoryExcelParams'
...
// ─── State ────────────────────────────────────────────────────────────────────
const sheetData = ref<IncidentCategoryModel[] | null>(null)
...
const AddIncidentCategory = async () => {
  ...
  await addIncidentCategoryController.addIncidentCategory(orgData, router)
  if (addIncidentCategoryController.isDataSuccess()) {
    emit('uploaded')
  }
}
  ...
  <div class="page-wrapper">
    <!-- <div class="excel-warning">
      ...
      <div class="rule-group">
        <div class="field-tags">
          <span class="field-tag">Incident Category Name</span>
        </div>
      </div>
      <hr class="separator" />
    </div> -->
    ...
    <template v-else>
      ...
      <template v-if="mappedData && mappedData.length > 0">
        ...
        <button @click="AddIncidentCategory" class="btn-confirm">Confirm & Submit</button>
      </template>
    </template>
  </div>
</template>

...
export default class IndexIncidentCategoryController extends SelectControllerInterface<
  IncidentCategoryModel[]
> {
  private static instance: IndexIncidentCategoryController
  private constructor() {
    super()
  }
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new IndexIncidentCategoryController()
    }

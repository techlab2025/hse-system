  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mb-4">
    ...
    <div class="col-span-2 flex justify-end gap-2">
      ...
      <PermissionBuilder :code="[
        ...
        <router-link :to="user?.type == OrganizationTypeEnum.ADMIN
            ? '/admin/areas/add'
    ...
    <DataStatus :controller="state">
      ...
      <template #empty>
        <PermissionBuilder :code="[
          ...
          <DataEmpty :link="user?.type == OrganizationTypeEnum.ADMIN
              ? '/admin/areas/add'
              : '/organization/areas/add'
            " addText="Add Area"
      ...
      <template #failed>
        <PermissionBuilder :code="[
          ...
          <DataFailed :link="user?.type == OrganizationTypeEnum.ADMIN
              ? '/admin/areas/add'
              : '/organization/areas/add'
            " addText="Add Area"
            description="Sorry .. You have no areas .. All your joined customers will appear here when you add your customer data"

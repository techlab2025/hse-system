...
export default class IndexSystemObserverationTypeController extends SelectControllerInterface<
  ObserverationTypeModel[]
> {
  private static instance: IndexSystemObserverationTypeController
  private constructor() {
    super()
  }
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new IndexSystemObserverationTypeController()
    }

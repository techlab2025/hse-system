...
import { AddSystemRootCausesApiService } from '../../Data/apiServices/addSystemRootCausesApiService'

class AddSystemRootCausesRepo extends RepoInterface<RootCausesModel> {
  private static instance: AddSystemRootCausesRepo
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new AddSystemRootCausesRepo()
    }
  ...
  get serviceInstance(): ServicesInterface {
    return AddSystemRootCausesApiService.getInstance()
  }
}

export { AddSystemRootCausesRepo }

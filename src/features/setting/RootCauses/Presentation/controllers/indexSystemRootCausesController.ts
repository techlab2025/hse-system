...
export default class IndexSystemRootCausesController extends SelectControllerInterface<
  RootCausesModel[]
> {
  private static instance: IndexSystemRootCausesController
  private constructor() {
    super()
  }
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new IndexSystemRootCausesController()
    }

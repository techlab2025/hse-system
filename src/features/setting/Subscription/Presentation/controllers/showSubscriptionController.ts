...
import ShowSubscriptionUseCase from '../../Domain/useCase/showSubscriptionUseCase'
...
export default class ShowSubscriptionController extends ControllerInterface<SubscriptionDetailsModel> {
  ...
  async showSubscriptionType(params: Params) {
    ...
    const dataState: DataState<SubscriptionDetailsModel> = await this.showSubscriptionUseCase.call(params)

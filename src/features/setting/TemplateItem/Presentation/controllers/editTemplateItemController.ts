...
export default class EditTemplateItemController extends ControllerInterface<TemplateItemModel> {
  private static instance: EditTemplateItemController

  private constructor() {
    super()
  }

  private editTemplateItemUseCase = new EditTemplateItemUseCase()

  static getInstance() {
    if (!this.instance) {
      this.instance = new EditTemplateItemController()
    }
    return this.instance
  }

  async editTemplateItem(params: Params, router: any) {

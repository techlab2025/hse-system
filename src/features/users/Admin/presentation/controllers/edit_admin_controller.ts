...
import type EditAdminParams from '../../Core/Params/edit_admin_params'
...
export default class EditAdminController extends ControllerInterface<AdminModel> {
  ...
  async editAdmin(params: EditAdminParams, router: any, draft: boolean = false) {
    ...
    try {
      ...
      const dataState: DataState<AdminModel> = await this.EditAdminUseCase.call(params)

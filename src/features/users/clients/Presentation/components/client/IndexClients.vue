...
import IndexClientParams from "@/features/dashboard/users/clients/Core/params/index_clients_params";
import ClientModel from "@/features/dashboard/users/clients/Data/models/index_client_model";
import IndexClientController from "@/features/dashboard/users/clients/Presentation/controllers/index_clients_controller";
...
import DeleteClientController from "@/features/dashboard/users/clients/Presentation/controllers/delete_client_controller";
import DeleteClientParams from "@/features/dashboard/users/clients/Core/params/delete_client_params";
import { ClientStatusEnum } from "@/features/dashboard/users/clients/Core/enums/client_status_enum";
import DataFailed from "@/components/DataStatues/DataFailed.vue";
import { useRoute } from "vue-router";
import DialogChangeStatusClient from "@/features/dashboard/users/clients/Presentation/components/client/DialogChangeStatusClient.vue";

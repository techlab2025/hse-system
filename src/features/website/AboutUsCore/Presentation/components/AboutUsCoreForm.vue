...
import AddAboutUsCoreParams from '../../Core/params/addAboutUsCoreParams'
import EditAboutUsCoreParams from '../../Core/params/editAboutUsCoreParams'

const emit = defineEmits(['update:data'])

const props = defineProps<{
  data?: AboutUsCoreDetailsModel
}>()

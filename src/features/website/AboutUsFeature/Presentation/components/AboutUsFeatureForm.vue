...
const updateData = () => {
  ...
  const params = props.data?.id
    ? new EditAboutUsFeatureParams(props.data?.id! ?? 0, translationsParams, alt.value, image.value)
    : new AddAboutUsFeatureParams(translationsParams, alt.value, image.value)

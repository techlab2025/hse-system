...
import { EditHeaderApiService } from '../../Data/apiServices/editHeaderApiService'
...
class EditHeaderRepo extends RepoInterface<HeaderModel> {
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new EditHeaderRepo()
    }
  ...
  get serviceInstance(): ServicesInterface {
    return EditHeaderApiService.getInstance()
  }
}

export { EditHeaderRepo }

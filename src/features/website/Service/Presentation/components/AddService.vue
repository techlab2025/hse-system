...
const saveAndNew = async () => {
  console.log(params.value, 'params')
  addServiceController.setLoading()
  await addServiceController.addService(params.value as AddServiceParams, stayOnPageRouter)
  if (addServiceController.isDataSuccess()) {
    params.value = null
    formKey.value++
  }
}
...
<template>
  <form class="grid grid-cols-1 md:grid-cols-4 gap-4" @submit.prevent="addService">
    <ServiceForm :key="formKey" @update:data="setParams" />

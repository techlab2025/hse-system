...
import { EditSystemFeatureApiService } from '../../Data/apiServices/editSystemFeatureApiService'
...
class EditSystemFeatureRepo extends RepoInterface<SystemFeatureModel> {
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new EditSystemFeatureRepo()
    }
  ...
  get serviceInstance(): ServicesInterface {
    return EditSystemFeatureApiService.getInstance()
  }
}

export { EditSystemFeatureRepo }

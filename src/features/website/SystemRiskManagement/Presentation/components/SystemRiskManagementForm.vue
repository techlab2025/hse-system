...
const fetchLang = async (
  ...
  const indexSystemRiskManagementController = await IndexLangController.getInstance().getData(params)
  ...
  if (response?.data?.length) {
    ...
    langDefault.value = response.data.map((item: any) => ({
      ...
      // if you already have icons mapped, use SystemRiskManagementsMap

...
const OrganizationSetting = ref<OrganizationSettingItem[]>([
  {
    ...
    routes: [
      ...
      },
      {
        ...
        Name: 'Warehouse Type',
        permissions: [
          PermissionsEnum.WHERE_HOUSE_TYPE_ALL,
          PermissionsEnum.WHERE_HOUSE_TYPE_CREATE,
          PermissionsEnum.WHERE_HOUSE_TYPE_DELETE,
          PermissionsEnum.WHERE_HOUSE_TYPE_FETCH,
          PermissionsEnum.WHERE_HOUSE_TYPE_UPDATE,
        ],
      },
      {
        ...
        Name: 'Warehouse',
        permissions: [
          PermissionsEnum.WHERE_HOUSE_ALL,
          PermissionsEnum.WHERE_HOUSE_CREATE,
          PermissionsEnum.WHERE_HOUSE_DELETE,
          PermissionsEnum.WHERE_HOUSE_FETCH,
          PermissionsEnum.WHERE_HOUSE_UPDATE,
        ],
      },
    ],
  },
